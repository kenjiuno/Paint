...
// Paint.cpp : アプリケーションのクラス動作を定義します。
//
...
BEGIN_MESSAGE_MAP(xApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &xApp::OnAppAbout)
...
BOOL xApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(xDoc),
		RUNTIME_CLASS(xFrame),       // メイン SDI フレーム ウィンドウ
		RUNTIME_CLASS(xView));
	if (!pDocTemplate)
		return FALSE;
